...
public class MigLayoutDemo {
    public static void main(String[] args) {
        ...
        JPanel radioPanel = new JPanel(new net.miginfocom.swing.MigLayout("wrap 1")); // wrap 1 let's us avoid adding the wrap constraing to every component
        ...
        JPanel buttonPanel = new JPanel(new net.miginfocom.swing.MigLayout("filly, wrap 2")); // filly tells it to take up all the vertical space
        ...
        JPanel contentPane = new JPanel(new net.miginfocom.swing.MigLayout("filly")); // again, we want to fill the vertical space so the 2 panels will have the same height
